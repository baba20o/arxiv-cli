"""Shared cross-process rate limiter for arXiv API calls.

arXiv API guidelines: max 1 request per 3 seconds.
"""
...
DEFAULT_DB_PATH = os.path.expanduser("~/.arxiv/rate_limit.db")
DEFAULT_MIN_INTERVAL = 3.0  # arXiv asks for 3 seconds between requests
...
class SharedRateLimiter:
    ...
    def report_rate_limit(self):
        logger.warning("Rate limit hit on arXiv API")
